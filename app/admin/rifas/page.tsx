    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Rifas Disponibles</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Rifas Activas</h2>
              ...
              return (
                <Card key={raffle.id} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <CardDescription className="text-sm">{raffle.description}</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>Sorteo: {new Date(raffle.drawDate).toLocaleDateString()}</span>
                      </div>
                    </div>

                    <Link href={`/rifas/${raffle.id}`}>
                      <Button className="w-full bg-red-600 hover:bg-red-700">Participar Ahora</Button>
                    </Link>
                  </CardContent>
                </Card>
              )
        ...
        {upcomingRaffles.length > 0 && (
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Próximas Rifas</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card key={raffle.id} className="opacity-75">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        <Calendar className="h-4 w-4 text-gray-500" />
                        <span>Inicia: {new Date(raffle.startDate).toLocaleDateString()}</span>
                      </div>
                    </div>
